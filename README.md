...
- [ ] Explain what a token is used for.
      Tokens are usef for authentication
- [ ] What steps can you take in your web apps to keep your data secure?
      Use tokens, axiosWithAuth, private routes and local storage
- [ ] Describe how web servers work.
      Web serves are responsible for storing, processing and delivering data to the web pages to users through htto
